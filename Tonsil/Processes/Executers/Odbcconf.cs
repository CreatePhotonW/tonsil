...
{
    class Odbcconf : Executer
    {
        public override string ImagePath { get; } = @"c:\windows\system32\Odbcconf.exe";
        ...
        public override string[] ArgumentsTemplate { get; } = new string[] { "-A", "{REGSVR", "{0}}}" };
